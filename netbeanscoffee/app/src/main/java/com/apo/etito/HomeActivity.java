...
//                }
                ...
                if (destination.getId() == R.id.nav_settings){
                    ...
                    Intent intent = new Intent(com.apo.netbeanscoffee.HomeActivity.this,SettingsActivity.class);
                    startActivity(intent);
                }
                if (destination.getId() == R.id.nav_logout){
                    Toast.makeText(HomeActivity.this, "Logout", Toast.LENGTH_SHORT).show();
                    Paper.book().destroy();
                    Intent intent = new Intent(com.apo.netbeanscoffee.HomeActivity.this,MainActivity.class);
